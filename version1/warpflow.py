...
def VGG16(source_imgs, target_imgs, sample_mean, loss_weight, hyper_params, is_training):
    ...
    with slim.arg_scope([slim.conv2d, slim.conv2d_transpose], 
        ...
        conv1_1 = slim.conv2d(tf.concat(3, [photo_in, photo_out]), 64, [3, 3], scope='conv1_1')
