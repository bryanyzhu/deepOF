...
def deep3D(inputs, outputs):
    ...
    with slim.arg_scope([slim.conv2d, slim.fully_connected], 
        ...
        d1 = slim.conv2d(pool1, channels, [3, 3], scope='d1')
        d2 = slim.conv2d(pool2, channels, [3, 3], scope='d2')
        d3 = slim.conv2d(pool3, channels, [3, 3], scope='d3')
        d4 = slim.conv2d(pool4, channels, [3, 3], scope='d4')
